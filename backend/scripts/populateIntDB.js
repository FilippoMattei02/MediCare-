        ...
        for (let i = 0; i < n_user; i++) {
            ...
            const newEmployee = await Employee.create({
                ...
                work: [
                    ...
                    { day: new Date(2024, 5, 5), start: (9 + i) % 24, end: (14 + i) % 24 },
                    ...
                    { day: new Date(2024, 6, 17), start: (9 + i) % 24, end: (17 + i) % 24 },
                    { day: new Date(2024, 6, 18), start: (9 + i) % 24, end: (17 + i) % 24 },
                    { day: new Date(2024, 6, 19), start: (9 + i) % 24, end: (17 + i) % 24 },
                    { day: new Date(2024, 6, 20), start: (9 + i) % 24, end: (17 + i) % 24 },
                    { day: new Date(2024, 6, 21), start: (10 + i) % 24, end: (17 + i) % 24 },
                    { day: new Date(2024, 6, 22), start: (9 + i) % 24, end: (17 + i) % 24 },
                    { day: new Date(2024, 6, 23), start: (9 + i) % 24, end: (17 + i) % 24 },
                    { day: new Date(2024, 6, 24), start: (9 + i) % 24, end: (17 + i) % 24 },
                    { day: new Date(2024, 6, 25), start: (15 + i) % 24, end: (17 + i) % 24 },
                    { day: new Date(2024, 6, 26), start: (9 + i) % 24, end: (14 + i) % 24 },
                    { day: new Date(2024, 6, 27), start: (9 + i) % 24, end: (14 + i) % 24 },
                    { day: new Date(2024, 6, 28), start: (3 + i) % 24, end: (17 + i) % 24 },
                    { day: new Date(2024, 6, 29), start: (9 + i) % 24, end: (17 + i) % 24 },
                    { day: new Date(2024, 6, 30), start: (9 + i) % 24, end: (17 + i) % 24 }
                ],
